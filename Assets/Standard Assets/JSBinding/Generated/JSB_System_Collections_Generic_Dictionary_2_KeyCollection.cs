...
public class JSB_System_Collections_Generic_Dictionary_2_KeyCollection
{
...
static bool KeyCollection_KeyCollection1(JSVCall vc, int argc)
{
    int _this = JSApi.getObject((int)JSApi.GetType.Arg);
    JSApi.attachFinalizerObject(_this);
    --argc;

    ConstructorInfo constructor = JSDataExchangeMgr.makeGenericConstructor(typeof(System.Collections.Generic.Dictionary<,>.KeyCollection), constructorID0); 
...
static void KeyCollection_Count(JSVCall vc)
{
...
// methods
public static MethodID methodID0 = new MethodID("CopyTo", "Void", TypeFlag.None, new string[]{"TKey[]", "Int32"}, new TypeFlag[]{TypeFlag.IsArray, TypeFlag.None});

static bool KeyCollection_CopyTo__TKey_Array__Int32(JSVCall vc, int argc)
{
...
static bool KeyCollection_GetEnumerator(JSVCall vc, int argc)
{
    // Get generic method by name and param count.
...
public static void __Register()
{
    ...
    ci.type = typeof(System.Collections.Generic.Dictionary<,>.KeyCollection);
    ...
    {
        new JSMgr.MethodCallBackInfo(KeyCollection_KeyCollection1, ".ctor"),

    };
    ci.methods = new JSMgr.MethodCallBackInfo[]
    {
        new JSMgr.MethodCallBackInfo(KeyCollection_CopyTo__TKey_Array__Int32, "CopyTo"),
        new JSMgr.MethodCallBackInfo(KeyCollection_GetEnumerator, "GetEnumerator"),
