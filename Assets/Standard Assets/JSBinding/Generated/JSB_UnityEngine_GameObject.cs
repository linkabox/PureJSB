...
public static MethodID methodID1 = new MethodID("AddComponent", "T", TypeFlag.IsT, null, null);
...
public static MethodID methodID9 = new MethodID("GetComponent", "T", TypeFlag.IsT, null, null);
...
public static MethodID methodID13 = new MethodID("GetComponentInChildren", "T", TypeFlag.IsT, null, null);
...
public static MethodID methodID15 = new MethodID("GetComponentInParent", "T", TypeFlag.IsT, null, null);
...
public static MethodID methodID19 = new MethodID("GetComponents", "T[]", TypeFlag.None, null, null);
...
public static MethodID methodID24 = new MethodID("GetComponentsInChildren", "Void", TypeFlag.None, new string[]{"List`1"}, new TypeFlag[]{TypeFlag.IsGenericType});

static bool GameObject_GetComponentsInChildrenT1__ListT1_T(JSVCall vc, int argc)
{
    // Get generic method by name and param count.
    MethodInfo method = JSDataExchangeMgr.makeGenericMethod(vc.csObj.GetType(), methodID24, 1); 
    if (method == null) return true;
...
public static MethodID methodID25 = new MethodID("GetComponentsInChildren", "T[]", TypeFlag.None, null, null);
...
public static MethodID methodID28 = new MethodID("GetComponentsInParent", "T[]", TypeFlag.None, new string[]{"Boolean"}, new TypeFlag[]{TypeFlag.None});
...
public static MethodID methodID30 = new MethodID("GetComponentsInParent", "T[]", TypeFlag.None, null, null);
